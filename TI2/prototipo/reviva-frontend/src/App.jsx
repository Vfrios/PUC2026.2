...
export default function RevivaApp() {
  ...
  switch (screen) {
    ...
    case "gerenciarItens": ScreenView = <conjunto1Gestao.GerenciarItens go={go} notify={notify} />; break;
    ...
    case "inbox": ScreenView = <conjunto3Screens.Inbox go={go} usuario={usuario} notify={notify} />; break;
    case "agendamentoDoador": ScreenView = <conjunto3Negociacao.Agendamento go={go} role="doador" notify={notify} params={params} usuario={usuario} />; break;
    case "confirmDoacao": ScreenView = <conjunto3Negociacao.ConfirmDoacao go={go} notify={notify} params={params} usuario={usuario} refreshUsuario={refreshUsuario} />; break;
    case "avaliarReceptor": ScreenView = <conjunto4Avaliacao.Avaliar go={go} notify={notify} params={params} />; break;
    case "dashboardImpacto": ScreenView = <conjunto3Negociacao.DashboardImpacto go={go} usuario={usuario} />; break;
    ...
    case "listaItens": ScreenView = <conjunto2Detalhes.ListaItens go={go} favorites={favorites} toggleFav={toggleFav} usuario={usuario} onlineIds={onlineIds} params={params} />; break;
    case "detalhesItem": ScreenView = <conjunto2Detalhes.DetalhesItem go={go} notify={notify} favorites={favorites} toggleFav={toggleFav} usuario={usuario} onlineIds={onlineIds} params={params} />; break;
    case "solicitacao": ScreenView = <conjunto3Negociacao.Solicitacao go={go} notify={notify} params={params} usuario={usuario} />; break;
    ...
    case "agendamentoReceptor": ScreenView = <conjunto3Negociacao.Agendamento go={go} role="receptor" notify={notify} params={params} usuario={usuario} />; break;
    case "confirmRecebimento": ScreenView = <conjunto3Negociacao.ConfirmRecebimento go={go} notify={notify} params={params} usuario={usuario} refreshUsuario={refreshUsuario} />; break;
    case "avaliarDoador": ScreenView = <conjunto4Avaliacao.Avaliar go={go} notify={notify} params={params} />; break;
    ...
    case "favoritos": ScreenView = <conjunto5Favoritos.Favoritos go={go} favorites={favorites} toggleFav={toggleFav} usuario={usuario} onlineIds={onlineIds} notify={notify} onFavoritosRemovidos={onFavoritosRemovidos} />; break;
    case "notificacoes": ScreenView = <conjunto6Seguranca.Notificacoes go={go} role={role} usuario={usuario} />; break;
    ...
    case "seguranca": ScreenView = <conjunto6Seguranca.Seguranca go={go} notify={notify} usuario={usuario} />; break;
    case "termos": ScreenView = <conjunto6Seguranca.Termos go={go} />; break;
    case "privacidade": ScreenView = <conjunto6Seguranca.Privacidade go={go} />; break;
